...
We will normalize our data using the TMM (trimmed mean of M) method. 
...
#write.table(ControlvsPOMV6_UP_ann, 'Results/ControlvsPOMV6_UP.csv', row.names = FALSE, sep = ",")
#write.table(ControlvsPOMV6_DOWN_ann, 'Results/ControlvsPOMV6_DOWN.csv', row.names = FALSE, sep = ",")
#write.table(ControlvsPOMV6_ALL_ann, 'Results/ControlvsPOMV6_ALL.csv', row.names = FALSE, sep = ",")

#write.table(ControlvsPOMV24_UP_ann, 'Results/ControlvsPOMV24_UP.csv', row.names = FALSE, sep = ",")
#write.table(ControlvsPOMV24_DOWN_ann, 'Results/ControlvsPOMV24_DOWN.csv', row.names = FALSE, sep = ",")
...
#write.table(ControlvsISAV24_UP_ann, 'Results/ControlvsISAV24_UP.csv', row.names = FALSE, sep = ",")
#write.table(ControlvsISAV24_DOWN_ann, 'Results/ControlvsISAV24_DOWN.csv', row.names = FALSE, sep = ",")
...
```{r}
library(dplyr)
data <- topTable(fit = fit.cont, sort.by="F",n=100)
...
```{r}
library(squash)
my_palette <- colorRampPalette(c("blue", "red"))(n = 1000)

rnames <- data_ann$ENTREZID
mat_data <- data.matrix(data_ann[,2:5])
rownames(mat_data) <- rnames
pheatmap::pheatmap(mat_data, cellwidth = 20, border_color = NA)
```
