...
REFDIR=/flush3/sam079/RNAseq-POMV/GenomeIndex/Bowtie
OUTDIR=/flush3/sam079/RNAseq-POMV/Processed/Alignment/AlignSalmonGenomeBowtie 
...
then
    ...
    tophat -p 8 --read-mismatches 10 --read-edit-dist 10 --max-multihits 10 -G ${ANODIR}/GCF_000233375.1_ICSASG_v2_genomic.gff -o ${OUTDIR}/${SAMPLES[$i]}_star_equivalent ${REFDIR}/Salmon ${INFILES_R1} ${INFILES_R2}
else
